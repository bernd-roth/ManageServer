 ...
 */
public final class EntryAdapterShutdownServer extends ArrayAdapter<EntryPoj> {

	private final int itemLayoutResource;

	public EntryAdapterShutdownServer(final Context context, final int itemLayoutResource) {
		super(context, 0);
	...
	public View getView(final int position, final View convertView, final ViewGroup parent) {
		...
		viewHolder.password.setText(entry.getPassword());
		viewHolder.ssh_port.setText(entry.getSsh_port());
	...
	private ViewHolder getViewHolder(final View workingView) {
		...
		if(null == tag || !(tag instanceof ViewHolder)) {
			...
			viewHolder.password = (TextView) workingView.findViewById(R.id.password);
			viewHolder.ssh_port = (TextView) workingView.findViewById(R.id.ssh_port);
